...
<body>
	...
	<main>
		...
		<section class="book-list">
			<div class="top">
				...
				<script>
						...
						%>
						<a
							href="cart?book_id=<%=b.getBookid()%>&&uname=<%=session.getAttribute("adminun")%>">
							<button>Add to Cart</button>
						</a>
				<script>
                function showAdd() {
					...
					<div class="add-cart-btn">
						<a href="viewbook.jsp?book_id=<%=b.getBookid()%>">
							<button>View</button>
						</a>
					</div>
				</article>
		...
		<h1 class="center-text">Recent Books</h1>
		<section class="book-list">
			<div class="top">
				<%
				BooksDAOImpl dao2 = new BooksDAOImpl(Connect.getConnection());
				List<BookDetails> list2 = dao.getRecentBook();
		...
		<h1 class="center-text">Old Books</h1>
		<section class="book-list">
			<div class="top">
				<%
				BooksDAOImpl dao3 = new BooksDAOImpl(Connect.getConnection());
				...
				<article class="book-item text-center">
					...
					<p>
						...
						<%=b.getPrice()%></p>
					<div class="add-cart-btn raghu">
						<button onclick="showWarning()">Add to Cart</button>
					</div>
					<div class="add-cart-btn">
						<a href="viewbook.jsp?book_id=<%=b.getBookid()%>">
							<button>View</button>
